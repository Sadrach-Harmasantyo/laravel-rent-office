...
import { z } from "zod";
import { Office } from "../lib/type";
import { formatRupiah } from "../lib/utils";
import { bookingSchema } from "../lib/validationBooking";
import apiClient, {
  BASE_URL_STORAGE,
  isAxiosError,
...
export default function BookOffice() {
  ...
  const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await apiClient.post("/api/booking-transaction", {
        ...formData,
        //
      });
        ...
        <div className="flex flex-col shrink-0 w-[400px] h-fit rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <p className="font-bold">{formatRupiah(office.price)}</p>
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <p className="font-bold text-[22px] leading-[33px] text-[#0D903A]">
                {formatRupiah(totalAmountWithUniqueCode)}
              </p>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col gap-[2px]">
                <div className="flex items-center gap-1">
                  <p className="font-semibold">FirstOffice Sadrach</p>
                  <img
